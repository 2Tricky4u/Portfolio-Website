...
summary: A fully functional ACMEv2 client with custom DNS/HTTP/HTTPS stacks, supporting dns-01 and http-01 challenges, wildcard domains, and automated revocation. RFC 8555 compliant and tested against Pebble.
period: '2024'
org: ETH Zürich
...
- **X.509 and RFC 8555 state machines.** CSR generation, certificate parsing, and the order to authorization to challenge to finalize to revoke flow modelled as compliant state machines.
